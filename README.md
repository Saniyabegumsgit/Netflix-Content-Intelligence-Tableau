...
* **Brand-Aligned Palette:** * **High-Contrast Palette:** Rejected software-default colors for an intentional, high-contrast Red and Grey theme to ensure instantaneous visual mapping and distinction across all four charts.
